...
## The five principles of restrained typography

**1. One typeface family, maximum two weights.**
Most expensive-looking layouts use a single typeface family with only regular and semibold (or medium). Some go as far as using only one weight. The constraint forces you to rely on size, spacing, and placement for hierarchy — which is exactly what makes a layout feel intentional.

**2. Generous whitespace is non-negotiable.**
Cheap layouts cram content. Expensive layouts give content room to breathe. Whitespace is not empty — it is a design element. When you see a layout with generous margins, wide line-height, and breathing room between sections, your brain registers it as expensive before you process a single word.

**3. Limited color palette.**
Restrained typography almost never uses more than two or three colors. Black or dark gray for body text, a single accent color for links and key elements, and white or off-white for background. Every additional color competes for attention and dilutes the hierarchy.

**4. Consistent alignment.**
Cheap layouts mix left-aligned, centered, and right-aligned text haphazardly. Expensive layouts pick one alignment system and follow it rigorously. Left-aligned body text with a consistent right edge is the most common expensive choice — it reads naturally and feels deliberate.

**5. Confident content selection.**
The most expensive layouts are often the shortest. They say fewer words, use bigger type, and trust the reader to fill in gaps. Every element on the page must earn its place. If it does not serve the core message, it goes.

## Why restraint reads as expensive

Restraint signals confidence. A designer who is confident does not need to fill every pixel with content, decorate every element, or prove their taste with exotic fonts. The emptiness is deliberate. The simplicity is curated. That is what reads as expensive.

## How to apply this to your personal homepage

You do not need a design degree to make your homepage feel expensive. Start with these steps:

1. Pick one typeface family and use it everywhere
2. Set a generous line-height (1.6 to 1.8 for body text)
3. Limit yourself to two colors plus white
4. Align everything to the same grid
5. Delete half of what you wrote

The result will feel more expensive than anything you could achieve by adding more.

## FAQ

**Does expensive typography require expensive fonts?**
No. The most expensive-looking layouts often use free Google Fonts. The expense comes from restraint, spacing, and confidence — not from the price tag of the typeface.

**What is the single most important typography rule?**
Consistency. A simple, consistent layout always reads as more expensive than a complex, inconsistent one. Pick your rules and follow them everywhere.

**Can too much whitespace make a layout feel empty?**
Yes, if the content is thin. Whitespace amplifies whatever is on the page. Good content with generous whitespace feels luxurious. Thin content with generous whitespace feels unfinished. Fill the page with substance first, then give it room.
